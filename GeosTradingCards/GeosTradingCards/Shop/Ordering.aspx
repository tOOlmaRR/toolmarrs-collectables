...
<asp:Content ID="mainContent" ContentPlaceHolderID="PageContent" runat="server">
	...
	<ol>
		<li><strong>Shopping</strong> : Surf around the site and, as you find items that you are interested in, make note of the ID numbers of the items you are interested in purchasing. ID numbers will be in the first column of all card listings available on this website. This is a quick way for us to identify and locate a particular card for you and our response times will be faster accordingly.</li>
